<section class="space-y-6">
    ...
    <x-breeze.danger-button x-data=""
        x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')">{{ __('Delete Account') }}</x-breeze.danger-button>
    ...
    <x-breeze.modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-breeze.text-input id="password" name="password" type="password" class="block w-3/4 mt-1"
