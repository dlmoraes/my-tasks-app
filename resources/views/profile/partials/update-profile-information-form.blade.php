<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-breeze.text-input id="name" name="name" type="text" class="block w-full mt-1" :value="old('name', $user->name)"
        ...
        <div>
            ...
            <x-breeze.text-input id="email" name="email" type="email" class="block w-full mt-1"
